...
Second, lots of new javascript and css frameworks have been born (e.x. AngularJS, Boostrap, ...) and symphony has become the leading php framework. Chive was build on Yii-Framework 1.1.4 + Jquery with custom CSS. This stack does not fullfill the requirements for a modern state of the art, maintainable codebase you would expect in 2014.
